...
class CourseAdmin(BaseModelAdmin):
    list_display = ("id", "title", "price", "total_duration", "max_students")
    search_fields = ("title",)
...
class LectureAdmin(BaseModelAdmin):
    list_display = ("id", "title", "course", "instructor", "thumbnail")


@admin.register(LectureChapter)
class LectureChapterAdmin(BaseModelAdmin):
    list_display = ("id", "title", "lecture", "material_url")


@admin.register(ChapterVideo)
class ChapterVideoAdmin(BaseModelAdmin):
    list_display = ("id", "title", "lecture_chapter", "video_url")
