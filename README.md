...
> “소리상상”은 음악(화성학) 교육 플랫폼으로 음악은 혼자만의 연습이 아니라 서로의 지식을 나누고 
함께 화음을 이루며 성장하는 공동체를 만드는 것을 목표로 합니다. 
이곳에서는 음악을 사랑하는 모든 이들이 자신만의 소리를 찾고, 다른 이들과 화음을 이루며, 음악의 즐거움을 공유할 수 있는 무대를 제공합니다.
